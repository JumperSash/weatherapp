...
import stylesCss from 'themes/wheaterapp/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_wheaterapp_componentCss']) {
    
    document['_vaadintheme_wheaterapp_componentCss'] = true;
  }
